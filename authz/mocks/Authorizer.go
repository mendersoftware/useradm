...
func (_m *Authorizer) WithLog(l *log.Logger) authz.Authorizer {
	ret := _m.Called(l)

	var r0 authz.Authorizer
	if rf, ok := ret.Get(0).(func(*log.Logger) authz.Authorizer); ok {
		r0 = rf(l)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(authz.Authorizer)
		}
	}
